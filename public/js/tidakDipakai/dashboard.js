...
function myContent(componentName) {
  ...
  dashboard[name] ? renderTemplate(name, componentName) : xhr(name, componentName);
}
...
function _xhr() {
  _xhr = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, componentName) {
    var getUrl, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('/view/' + componentName);

          case 2:
            getUrl = _context.sent;
            _context.next = 5;
            return getUrl.text();
          ...
          case 5:
            ...
            _context.next = 9;
            return renderTemplate(name, componentName);
...
function htmlToElement(html, id) {
  var template = document.createElement('template'); // html = html.trim(); // Never return a text node of whitespace as the result
...
function newElement(name, componentName) {
  return customElements.define(componentName, /*#__PURE__*/function (_HTMLElement) {
    ...
    function _class() {
      ...
      var template = htmlToElement(dashboard[name], componentName);
