...
@section('body')
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="toggles2" viewBox="0 0 16 16">
      ...
      <path d="M14 4a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"/>w
    </symbol>
  ...
  <div class="d-flex">
    <aside class="">
      <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sticky" style="max-width: 280px; height:100vh">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="/dashboard/dpls-index" onclick="Dashboard.showContent('dpls-index','chart/chart.bundle.js','table/getPage.js' )"
    ...
    {{-- <script defer> Dashboard.showContent('dpls-create','editor/editor.bundle') </script> --}}
    {{-- <script defer> Dashboard.showContent('dpls-index') </script> --}}
    {{-- <script defer> Dashboard.showContent('dpls-table') </script> --}}
  </div>
@endsection
