...
@section('body')
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <Symbol id="worksheet" viewBox=" 0 0 16 16">
      <path
    ...
    <Symbol id="dpl" viewBox=" 0 0 16 16">
      <path
    ...
    <Symbol id="engjust" viewBox=" 0 0 16 16">
      <path
    ...
    <Symbol id="ctre" viewBox=" 0 0 16 16">
      <path
    ...
    <Symbol id="non-conformance-product" viewBox=" 0 0 16 16">
      <path
  ...
  <div class="d-flex">
    <aside class="">
      <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sticky" style="max-width: 280px; height:100vh">
        ...
        <button class="btn btn-primary mb-3" wire:click="redirectPage()">Home</button>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="/dashboard/user-dpls-index" onclick="Dashboard.showContent('user-dpls-index','chart/chart.bundle')"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li>
            ...
            <a href="/dashboard/user-settings-profile" onclick="Dashboard.showContent('user-settings-profile')"
              class="nav-link text-white">
              <svg class="bi pe-none me-2" width="16" height="16">
            ...
            <a href="/dashboard/user-settings-unmpwd" onclick="Dashboard.showContent('user-settings-unmpwd')"
              class="nav-link text-white">
              <svg class="bi pe-none me-2" width="16" height="16">
    ...
    {{-- <script async fetchpriority="high" src="{{ url('js/chart/chart.bundle.js') }}"></script> --}}
    {{-- <script async fetchpriority="high" src="{{ url('js/editor/editor.bundle.js') }}"></script> --}}
    <script>
      (function() {
        function loadScript(url, method) {
          let script = document.createElement('script')
          script.setAttribute('fetchpriority', 'low');
          script.src = "http://" + window.location.host + '/js/' + url;
          script.setAttribute('onload', method)
          // script.setAttribute('onload', "alert('foo')")
          document.body.appendChild(script);

        }
        window.addEventListener('DOMContentLoaded', function() {
          // setTimeOut() berfungsi agar loading page selesai dulu, baru render script
          setTimeout(() => {
            loadScript('editor/editor.bundle.js', 'Dashboard.renderEditor()')
            loadScript('chart/chart.bundle.js', 'Dashboard.renderChart()')
          }, 1);
        })
      })()
    </script>
    ...
    {{-- <script src="{{ url('js/contohScript123.js') }}"></script> --}}


    {{-- <script defer> Dashboard.showContent('user-dpls-create','editor/editor.bundle') </script> --}}
    {{-- <script defer> Dashboard.showContent('user-dpls-index') </script> --}}
    {{-- <script defer> Dashboard.showContent('user-dpls-table') </script> --}}
  </div>
@endsection
